...
(function (b, k, l, m) {
	...
	g.prototype = {
		...
		start: function () {
			this.state ||
				((this.state = 1), this.resetInterval(), this.options.start());
		},
		stop: function () {
			this.state &&
		...
		moveNext: function () {
			"down" === this.options.direction
				? this.moveDown()
				: "up" === this.options.direction && this.moveUp();
		},
		movePrev: function () {
			"down" === this.options.direction
				? this.moveUp()
				: "up" === this.options.direction && this.moveDown();
		},
		pause: function () {
		...
		updateOption: function (a, b) {
			"undefined" !== typeof this.options[a] &&
				((this.options[a] = b), "duration" == a || "speed" == a) &&
				(this.checkSpeed(), this.resetInterval());
		},
		add: function (a) {
		...
		checkSpeed: function () {
			this.options.duration < this.options.speed + 25 &&
