...
document.addEventListener("DOMContentLoaded", () => {
  ...
  */
    ...
    if (savedDirection === "rtl") {
        ...
        styleLink.setAttribute("href", "assets/stylesheets/styles-rtl.html");
    ...
    rtlButton.addEventListener("click", function () {
        ...
        if (isRTL) {
            ...
            styleLink.setAttribute(
                "href",
                "assets/stylesheets/styles-rtl.html"
            );
...
document.querySelector(".grid").addEventListener("click", function () {
    const color = document.querySelector(".cell-label").style.color;
    document.querySelectorAll(".product-cell").forEach(function (el) {
        el.style.color = "#eee";
    });
...
document.querySelector(".list").addEventListener("click", function () {
    ...
    document.querySelectorAll(".tt").forEach(function (ell) {
        ell.style.color = "#fff";
    });
});

// category sales stock price
